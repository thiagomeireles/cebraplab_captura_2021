...
```{r}
file1 <- "https://raw.githubusercontent.com/thiagomeireles/cebraplab_captura_2021/main/dados/bf_amostra_hv.csv"
```
...
```{r}
file2 <- "https://raw.githubusercontent.com/thiagomeireles/cebraplab_captura_2021/main/dados/bf_amostra_nv.csv"
```
...
```{r}
# Ponto e virgula
file3 <- "https://raw.githubusercontent.com/thiagomeireles/cebraplab_captura_2021/main/dados/bf_amostra_hp.csv"
dados <- read.table(file3, header = T, sep = ";")

file4 <- "https://raw.githubusercontent.com/thiagomeireles/cebraplab_captura_2021/main/dados/bf_amostra_ht.csv"
...
```{r}
# SPSS
download.file("https://raw.githubusercontent.com/thiagomeireles/cebraplab_captura_2021/main/dados/F00004529-Latinobarometro_2015_sav.zip", "latino2015_sav.zip")
unzip("latino2015_sav.zip")

# STATA
download.file("https://raw.githubusercontent.com/thiagomeireles/cebraplab_captura_2021/main/dados/F00004530-Latinobarometro_2015_dta.zip",  "latino2015_dta.zip")
...
```{r}
download.file("https://raw.githubusercontent.com/thiagomeireles/cebraplab_captura_2021/main/dados/F00004532-Latinobarometro_2015_r.zip",
