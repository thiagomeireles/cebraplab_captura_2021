# Tutorial 1: Introdução ao *rvest* e revisão
...
Ao acessar o site, podemos elaborar uma pesquisa que retorne um númedo de respostas que tornaria ineficiente a coleta manual com, por exemplo, a palavra "coronavírus".
